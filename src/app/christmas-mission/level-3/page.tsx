...
const LEVEL_3_PASSWORD = "danailovi"; // Text password revealed via QR code in YouTube video
const LEVEL_3_PIN = "170205"; // 6-digit PIN to be found in house
const RIDDLES = [
  {
    question: "Там гравитацията губи своята власт,\nа публиката гледа в пълен захлас.\nНе е магия, но изглежда така,\nпод шарен покрив стават чудеса.",
    answer: "tsirk",
    hint: "The Circus"
  },
  {
    question: "Без нея салатата е самотна,\nдори трапезата да е страхотна.\nНаздраве казваме с нея,\nпреди душата ми да се засмея.",
    answer: "rakia",
    hint: "Rakia"
  },
  {
    question: "Навита на кълбо, но не е змия,\nухае на празник, на топла земя.\nВ своите дипли бъдещето крие,\nна масата днес ще я сборим ние.",
    answer: "banitsa",
    hint: "Banitsa"
  }
];
...
export default function Level3Page() {
  ...
  useEffect(() => {
    ...
    const audio = new Audio("/level-3.mp3");
    audio.loop = true;
    audio.volume = 0.5;
  ...
  const handlePasswordSubmit = (e: React.FormEvent) => {
    ...
    if (
      normalizedPassword === LEVEL_3_PASSWORD.toLowerCase() ||
      ...
      // After tick animation, show PIN hint
      setTimeout(() => {
        setShowTick(false);
    ...
    <div className="min-h-screen w-full bg-black text-green-400 font-mono relative py-12">
      ...
      <div className="relative z-10 max-w-2xl w-full px-8 mx-auto">
        <AnimatePresence mode="wait">
          {!isUnlocked && !showPasswordHint && !showPinHint ? (
            <motion.div
              key="riddles"
              initial="initial"
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <motion.p
                    className="text-gray-300 mb-6 font-mono text-xl leading-relaxed whitespace-pre-line"
                    variants={textItemVariants}
                    transition={textTransition}
                  >
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mt-1">[ LOCKED ] - Password Hunt</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <motion.p
                    ...
                    transition={textTransition}
                  >
                    Excellent! All riddles solved. Now find the password.
                    <br />
                    <br />
                    <span className="text-green-400 italic">
                      Тази врата се отваря с мелодия, не с думи, а с въздушна рапсодия.<br />
                      Любим коледен хит с уста изсвирете,<br />
                      и за &quot;динг&quot; от телефона на мама следете.
                    </span>
                  </motion.p>
              ...
              >
                ...
                >
                  ...
                  <motion.p
                    ...
                    transition={textTransition}
                  >
                    Password found! Now find the final 6-digit code.
                    <br />
                    <br />
                    <span className="text-green-400 italic">
                      С този уред татко командва мрака,<br />
                      и кара екрана в нощта да зачака.<br />
                      Обърни го обратно, намери капак,<br />
                      отдолу се крие финалният знак.
                    </span>
                  </motion.p>
                ...
                >
                  <div className="relative w-full" style={{ paddingBottom: "56.25%" }}>
                    <iframe
                      ...
                      src="https://www.youtube.com/embed/XpzeMitvFPY?si=iSpOynBSEsLzuwkp"
